...
_Fable.MeadowMSSQLProvider.connect(
    (pError, pConnectionPool) =>
    {
        ...
        for (let i = 0; i < _BookStoreTableList.length; i++)
        {
            ...
            _DAL[tmpDALEntityName].setProvider('MSSQL');
                    ...
                    (pResults) =>
                    {
                        _Fable.Utility.waterfall([
                            (fStageComplete) =>
                            {
                                ...
                                _Fable.Utility.eachLimit(pResults.data, 10,
                            ...
                            (fStageComplete) =>
                            {
                                ...
                                _Fable.Utility.eachLimit(pResults.data, 10,
                                    (pBookDataRow, fCallback) =>
                                    {
                                        ...
                                        _Fable.Utility.eachLimit(tmpAuthorsToCreate, 1,
                            ...
                            (fStageComplete) =>
                            {
                                ...
                                _Fable.Utility.eachLimit(pResults.data, 10,
                                    (pBookDataRow, fCallback) =>
                                    {
                                        ...
                                        _Fable.Utility.eachLimit(tmpAuthorJoinsToCreate, 1,
